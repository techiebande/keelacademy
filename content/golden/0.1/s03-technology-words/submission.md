...
An AI agent reads the message the moment it arrives, and an LLM finds the order and checks the rulebook. If everything is clear, the customer gets a correct answer within the hour, and a record is written with what the decision was based on. If anything is unclear, the case goes to a person with all the facts already gathered, and nothing is paid until that person decides. Every decision, whoever made it, is recorded and never edited; a correction is a new record.
