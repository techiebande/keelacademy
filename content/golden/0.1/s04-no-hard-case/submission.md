...
A message is read the moment it arrives. The order and delivery record are found and the rulebook is checked. If everything is clear, the customer gets a correct answer within the hour, and a record is written with what the decision was based on. Every decision, whoever made it, is recorded and never edited; a correction is a new record.
