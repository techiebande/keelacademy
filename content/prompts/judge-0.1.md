...
What Lantern is, so you can judge accuracy: an online shop selling household goods. About three thousand customer messages a month about orders (not arrived, damaged, wrong item, refund). Eight support agents. A message waits two to three days before anyone reads it; handling one takes about twenty minutes of looking up the order, the courier's delivery record, any photo, and the twenty-rule rulebook. Sarah Johnson owns the shop and wants answers within an hour without hiring more people. Michael Brown keeps the books and wants every decision recorded with what it was based on, never edited afterwards. Rachel Smith runs support, wrote the rulebook, wants rules applied consistently and every unclear case to reach a person before anything is paid.

Rules for your judgment:

- Judge substance, not wording. A student who describes Michael's need as "the accountant must be able to see a year later why every refund was paid, and nobody can change that record" has met the criterion even without the word "audit".
- The three people must differ. If the paragraphs for Sarah, Michael and Rachel could be swapped, `three-people-differ` fails.
